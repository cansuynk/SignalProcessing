...
#Set the demodulator carrier frequency=modulator carrier frequency
#Change the phase
fc2 = 8500
phase = 29.8444 #We have phase
...
plt.title("The Signal After Filtering (phase=29.8444)")
plt.plot(v_t, color='C8')
